...
class Property {
    ...
    TYPES = {
        ...
        INT: "INT", // 天才值 intelligence INT
        STR: "STR", // 体质 strength STR
        MNY: "MNY", // 穷鬼币 money MNY
        SPR: "SPR", // 快乐 spirit SPR
        LIF: "LIF", // 生命 life LIFE
        TLT: "TLT", // 穷鬼天赋 talent TLT
        ...
        LINT: "LINT", // 最低天才值 Low Intelligence
        HINT: "HINT", // 最高天才值 High Intelligence
        LSTR: "LSTR", // 最低体质 Low Strength
        HSTR: "HSTR", // 最高体质 High Strength
        LMNY: "LMNY", // 最低穷鬼币 Low Money
        HMNY: "HMNY", // 最高穷鬼币 High Money
